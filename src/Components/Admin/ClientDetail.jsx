...
const ClientDetail = () => {
  ...
  const handleDelete = async () => {
    if (window.confirm("Are you sure you want to delete this client permanently?")) {
      try {
      ...
      <div className="admin-wrapper">
        <div className="admin-container">
          <div className="admin-header">
            ...
            <button onClick={() => navigate("/admin")} className="btn-action edit">
              ← Back
            </button>
          </div>
          ...
          <div className="client-detail-container">
            ...
            <div className="detail-photo-section">
              {!isEditing ? (
                ...
                photoUrl ? (
                  <div>
                    <h4 style={{ marginBottom: '10px', color: 'var(--text-secondary)' }}>Client Photo</h4>
                    <img
                      src={photoUrl}
